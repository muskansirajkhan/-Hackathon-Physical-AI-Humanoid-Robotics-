...
const config: Config = {
  ...
  // ✅ Deployment config
  url: isVercel ? 'https://your-vercel-domain.vercel.app' : 'https://muskansirajkhan.github.io',
  baseUrl: isVercel ? '/' : '/-Hackathon-Physical-AI-Humanoid-Robotics-/',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        { type: 'docSidebar', sidebarId: 'textbookSidebar', position: 'left', label: 'Chapters' },
        { href: 'https://github.com/muskansirajkhan', label: 'GitHub', position: 'right' },
      ],
    },
      ...
      links: [
        {
          title: 'Textbook',
          items: [
            { label: 'Chapter 1: Introduction', to: '/docs/chapter-1-introduction-to-physical-ai' },
            { label: 'Chapter 6: Capstone', to: '/docs/chapter-6-capstone-ai-robot-pipeline' },
          ],
        },
        {
          title: 'Resources',
        ...
        {
          title: 'More',
          items: [{ label: 'GitHub', href: 'https://github.com/muskansirajkhan' }],
        },
      ],
